...
public class MyLevel extends AbstractGameLevel {
	Canvas canvas;
	static int[][] map = { 
	...
	// Add antity
	MyMovableEntity me = new MyMovableEntity(canvas,"images/pac1.gif");
	...
	me.setPosition(new Point(14 * SPRITE_SIZE, 17 * SPRITE_SIZE));
